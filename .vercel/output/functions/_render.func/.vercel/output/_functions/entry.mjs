...
import { e as ensure404Route, d as default404Instance, D as DEFAULT_404_ROUTE, m as manifest } from './chunks/_@astrojs-manifest_DvPG3ldS.mjs';
...
const _page4 = () => import('./pages/api/user/createuser.astro.mjs');
const _page5 = () => import('./pages/api/user/me.astro.mjs');
const _page6 = () => import('./pages/api/user/_mepublic_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/user/createUser.ts", _page4],
    ["src/pages/api/user/me.ts", _page5],
    ["src/pages/api/user/[mepublic].ts", _page6],
...
const _args = {
    "middlewareSecret": "e02d9541-d37e-4b0c-9f40-2971a81c3fc2",
